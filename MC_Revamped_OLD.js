/*MC Revamped*/
/*DO NOT REDISTRUBUTE WITHOUT MY PERMISSION!*/
/*ENJOY my firts ModPE script!*/

ModPE.setItem(500, "emerald", 0, "Emerald");
ModPE.setItem(405, "skull_creeper", 0, "EpicPick");
ModPE.langEdit("item.EpicPick.name", "Epic Pickaxe");
Item.setMaxDamage(465, 369);
ModPE.setItem(408, "fireworks_charge", 0, "MagicalEssence");
ModPE.langEdit(" item.MagicalEssence.name", "Magical Essence");
Item.addFurnaceRecipe(196, 500, 0);
Item.addFurnaceRecipe(197, 406, 0);
ModPE.overrideTexture("images/items-opaque.png", "http://i.imgur.com/kGcrwrl.jpg");
Item.addFurnaceRecipe(204, 408, 0);
ModPE.setFoodItem(467, 0, 0, 20);
ModPE.setItem(407, "fireball", 0, "ObsidianToolRod");
ModPE.langEdit(" item.ObsidianToolRod.name", "Obsidian Tool Rod");
Item.addCraftRecipe(407, 1, 0, [49, 2, 0]);
Item.setCategory(407, 1);
Item.addCraftRecipe(405, 1, 0, [407, 2, 0, 408, 3, 0]);
Item.setCategory(405, 1);
...
if(cmd[0] == "info")
{
clientMessage(ChatColor.GOLD + "Item ID's : " + ChatColor.DARK_PURPLE + "500, 190, 195, 196, 197, 198, 199, 200,"); clientMessage(ChatColor.DARK_PURPLE + "201, 202, 203, 204, 205, 405, 407, 408");
...
Player.addItemInventory(405, 64, 0);
Player.addItemInventory(407, 64, 0);
...
clientMessage(ChatColor.AQUA + "By: drag0nrider27" + ChatColor.RED + " Version 1.4.2");
